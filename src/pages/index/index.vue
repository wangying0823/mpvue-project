<template>
  <div class="content">
    ...
    <div class="Entrance">
      <div class="EntranceIcon" @click="radioList">
    ...
    <div class="songList" style="margin-top:20rpx">
      <div class="songTop">今日单曲
        <i @click="singleList" style="background:url(data:image/svg+xml;base64,); background-size:24rpx 24rpx; width:24rpx;height:24rpx;"></i>
      </div>
      <div class="Single">
    ...
    <div class="songList">
      <div class="songTop">今日电台
        <i @click="radioList" style="background:url(data:image/svg+xml;base64,); background-size:24rpx 24rpx; width:24rpx;height:24rpx;"></i>
      </div>
      <div class="songitem">
    ...
    <div class="Playing" @click="listenerButtonPause" :class="{'xuanzhuan': currMusic.isPlay}">
      <div class='wrap'>
        <img :src="currMusic.picUrl" alt="" style="width:120rpx;height:120rpx;border-radius: 100%">
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState('songList', {
      currMusic: state => state.currMusic
    })
  },
  methods: {
    ...mapActions('songList', ['addPlayItem']),
    async getBanner(url, params){
      this.banner = await getRequest({url, params});
    },
    async getSongitem(url, params){
      this.songitem = await getRequest({url, params});
    },
    async getSingle(url, params){
      this.single = await getRequest({url, params});
    },
    async getRadio(url, params){
      this.radio = await getRequest({url, params});
    },
    //监听button暂停按钮
    ...
    singleList(){
      const url = "../single/main";
      wx.navigateTo({ url });
    },
    radioList(){
      const url = "../radio/main";
      wx.navigateTo({ url });
    }
  },
  mounted(){
    ...
    //获取今日歌单
    this.getSongitem('/personalized', {})
    // 获取单曲
    this.getSingle('/personalized/newsong', {});
    // 获取电台
    this.getRadio('personalized/djprogram', {});
  }
}
</script>
