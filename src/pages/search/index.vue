...
<script>
  ...
  export default {
    ...
    async onLoad(options){
      ...
      let firstSearchUrl = "/search?keywords=" + firstSearch;
      let data = await getRequest(firstSearchUrl, {});
      this.searchData = data.songs;
    },
    methods: {
      ...
      async searchI() {
        ...
        let searchValueUrl ="/search?keywords=" + searchValue;
        let data = await getRequest(firstSearchUrl, {});
        this.searchData = data.songs;
      },
      musicUrl(e) {
